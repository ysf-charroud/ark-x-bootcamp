...
const Navbar = () => {
  return (
    <header>
      <div className="flex bg-primary justify-center items-center gap-x-5 py-2">
        <svg
          width="24"
          height="24"
          viewBox="0 0 24 24"
        ...
        <button className="bg-foreground text-white py-1 px-3 rounded-full ">
          More Info
        </button>
      </div>
      ...
      <nav className="flex items-center justify-between px-6 py-4 border-b border-gray-200">
        ...
        <div className="space-x-2">
          <button className="py-2 px-5 cursor-pointer bg-primary rounded-full text-white font-medium">Sign in</button>
          <button className="py-2 px-5 cursor-pointer  rounded-full text-foreground border border-gray-200 font-medium">Sign up</button> 
        </div>
      </nav>
    </header>
  );
